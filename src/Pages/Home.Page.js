    ...
    <View style={{flex:1}}>
        ...
        >
         <ScrollView style={[{flex: 1}, styles.container]}> 
            ...
            <List navigation={this.props.navigation} contentPath="now_playing" title="현재 상영작" />
            <List navigation={this.props.navigation} contentPath="top_rated" title="랭킹별 영화" />
            <List navigation={this.props.navigation} contentPath="popular" title="인기작" />
            <List navigation={this.props.navigation} contentPath="upcoming" title="싱영 예정작" />
        </ScrollView>
        </SideMenu> 
    </View>
  )
